...
char* rand_corrupt(unsigned char* buff,unsigned short int bytes)
{
	char* str_temp = NULL;
	str_temp = (char*)calloc(1,bytes+1); //allocate memory for a string 
	int i;
	int num;
