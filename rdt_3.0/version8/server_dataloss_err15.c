...
int main(int argc, char *argv[])
{
	...
	newfp = fopen("new_home15.jpg","wb"); // open the new file in write mode//
	...
	while(received<packets+1)
	{
		...
		if (received == packets) {
			...
			//execution of the code below
               ...
               //let there be 15% data loss

		if(num>=15)  //if the data loss has not occured ,then consider the packet,else ignore it
	       {
